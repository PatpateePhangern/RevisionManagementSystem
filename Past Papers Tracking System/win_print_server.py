#!/usr/bin/env python3
"""
win_print_server.py — Advanced LAN Print Receiver for Windows PC  v2.2
=======================================================================
Run this script on your Windows PC. It listens for PDF payloads sent from
the Mac's PaperTracker app.
...
<title>win_print_server v2.2</title>
<style>
...
<h1>✅ win_print_server.py v2.2 is running</h1>
<p>{py32_status}</p>
...
if __name__ == "__main__":
    ...
    print("=" * 65)
    print("  win_print_server.py  —  Advanced LAN Print Receiver  v2.2")
    print("=" * 65)
